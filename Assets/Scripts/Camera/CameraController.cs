...
namespace PFAS.Cam
{
    public class CameraController : MonoBehaviour
    {
        ...
        [Header("Smooth Camera Translation")]
        ...
        public void RelocateCountry(Vector3 p_countryPos)
        {
            ...
            _cameraTransitionCoroutine = StartCoroutine(_SmoothMoveCamera(transform.position, t_targetCamPos, _cam.orthographicSize, _targetZoomToCountry, _cameraTransitionDuration));
